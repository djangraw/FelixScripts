...
# execute via : 
#   tcsh -xef afni_srtt_v2_tb8818.tcsh 2>&1 | tee output.afni_srtt_v2_tb8818.tcsh
...
3dcopy anat/Sag3DMPRAGEs008a1001.nii.gz $output_dir/Sag3DMPRAGEs008a1001
...
# (new anat will be intermediate, stripped, Sag3DMPRAGEs008a1001_ns+orig)
align_epi_anat.py -anat2epi -anat Sag3DMPRAGEs008a1001+orig \
...
auto_warp.py -base MNI_caez_N27+tlrc -input Sag3DMPRAGEs008a1001_ns+orig \
...
if ( ! -f Sag3DMPRAGEs008a1001_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: Sag3DMPRAGEs008a1001_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                       \
               anat.un.aff.Xat.1D                                             \
               Sag3DMPRAGEs008a1001_al_junk_mat.aff12.1D -I                   \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc
    # then apply non-linear standard-space warp
    3dNwarpApply -master Sag3DMPRAGEs008a1001_ns+tlrc -dxyz 3                 \
...
3dcopy Sag3DMPRAGEs008a1001_ns+tlrc anat_final.$subj
...
3dNwarpApply -source Sag3DMPRAGEs008a1001+orig                                \
...
3dresample -master full_mask.$subj+tlrc -input Sag3DMPRAGEs008a1001_ns+tlrc \
...
#
# afni_proc.py -subj_id tb8818 -script afni_srtt_v2_tb8818.tcsh -out_dir      \
#     tb8818.srtt_v2 -dsets func_srtt/ep2dbold156s004a001.nii.gz              \
#     func_srtt/ep2dbold156s006a001.nii.gz                                    \
#     func_srtt/ep2dbold156s008a001.nii.gz -blocks despike tshift align tlrc  \
#     volreg blur mask regress -copy_anat anat/Sag3DMPRAGEs008a1001.nii.gz    \
