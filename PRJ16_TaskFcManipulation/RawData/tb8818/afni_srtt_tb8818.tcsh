...
# execute via : 
#   tcsh -xef afni_srtt_tb8818.tcsh 2>&1 | tee output.afni_srtt_tb8818.tcsh
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGEs008a1001_ns+orig \
...
foreach run ( $runs )
    ...
    3dAllineate -base Sag3DMPRAGEs008a1001_ns+orig                            \
...
3dcopy Sag3DMPRAGEs008a1001_ns+orig anat_final.$subj
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGEs008a1001_ns+orig \
...
#
# afni_proc.py -subj_id tb8818 -script afni_srtt_tb8818.tcsh -out_dir         \
#     tb8818.srtt -dsets func_srtt/ep2dbold156s004a001.nii.gz                 \
#     func_srtt/ep2dbold156s006a001.nii.gz                                    \
#     func_srtt/ep2dbold156s008a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGEs008a1001.nii.gz           \
