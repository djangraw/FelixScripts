...
# execute via : 
#   tcsh -xef afni_srtt_v3_tb6812.tcsh 2>&1 | tee output.afni_srtt_v3_tb6812.tcsh
...
auto_warp.py -base MNI152_T1_2009c+tlrc -input Sag3DMPRAGEs003a1001_ns+orig \
...
#
# afni_proc.py -subj_id tb6812 -script afni_srtt_v3_tb6812.tcsh -out_dir      \
#     tb6812.srtt_v3 -dsets func_srtt/ep2dbold156s005a001.nii.gz              \
...
#     anat/Sag3DMPRAGEs003a1001.nii.gz -anat_has_skull yes                    \
