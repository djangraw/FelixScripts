...
# execute via : 
#   tcsh -xef afni_srtt_tb8357.tcsh 2>&1 | tee output.afni_srtt_tb8357.tcsh
...
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    func_srtt/ep2dbold156s003a001.nii.gz'[6..$]'
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGEs002a1001_ns+orig \
...
foreach run ( $runs )
    ...
    3dAllineate -base Sag3DMPRAGEs002a1001_ns+orig                            \
...
3dcopy Sag3DMPRAGEs002a1001_ns+orig anat_final.$subj
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGEs002a1001_ns+orig \
...
1d_tool.py -infile dfile_rall.1D -set_run_lengths 150 150 150 99         \
...
1dcat X.nocensor.xmat.1D'[16]' > ideal_uns1.1D
1dcat X.nocensor.xmat.1D'[17]' > ideal_uns2.1D
1dcat X.nocensor.xmat.1D'[18]' > ideal_uns3.1D
1dcat X.nocensor.xmat.1D'[19]' > ideal_str1.1D
1dcat X.nocensor.xmat.1D'[20]' > ideal_str2.1D
1dcat X.nocensor.xmat.1D'[21]' > ideal_str3.1D
...
#
# afni_proc.py -subj_id tb8357 -script afni_srtt_tb8357.tcsh -out_dir         \
#     tb8357.srtt -dsets func_srtt/ep2dbold156s003a001.nii.gz                 \
#     func_srtt/ep2dbold156s004a001.nii.gz                                    \
#     func_srtt/ep2dbold156s006a001.nii.gz                                    \
#     func_srtt/ep2dbold156s008a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGEs002a1001.nii.gz           \
