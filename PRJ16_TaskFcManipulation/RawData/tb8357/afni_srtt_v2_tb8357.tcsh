...
# execute via : 
#   tcsh -xef afni_srtt_v2_tb8357.tcsh 2>&1 | tee output.afni_srtt_v2_tb8357.tcsh
...
auto_warp.py -base MNI_caez_N27+tlrc -input Sag3DMPRAGEs002a1001_ns+orig \
...
#
# afni_proc.py -subj_id tb8357 -script afni_srtt_v2_tb8357.tcsh -out_dir      \
#     tb8357.srtt_v2 -dsets func_srtt/ep2dbold156s003a001.nii.gz              \
...
#     volreg blur mask regress -copy_anat anat/Sag3DMPRAGEs002a1001.nii.gz    \
