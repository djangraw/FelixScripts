...
# execute via : 
#   tcsh -xef afni_srtt_tb5688.tcsh 2>&1 | tee output.afni_srtt_tb5688.tcsh
...
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    func_srtt/ep2dbold136s004a001.nii.gz'[6..$]'
...
1d_tool.py -infile dfile_rall.1D -set_run_lengths 130 150 150            \
...
1dcat X.nocensor.xmat.1D'[9]' > ideal_uns1.1D
1dcat X.nocensor.xmat.1D'[10]' > ideal_uns2.1D
1dcat X.nocensor.xmat.1D'[11]' > ideal_uns3.1D
1dcat X.nocensor.xmat.1D'[12]' > ideal_str1.1D
1dcat X.nocensor.xmat.1D'[13]' > ideal_str2.1D
1dcat X.nocensor.xmat.1D'[14]' > ideal_str3.1D
...
#
# afni_proc.py -subj_id tb5688 -script afni_srtt_tb5688.tcsh -out_dir         \
#     tb5688.srtt -dsets func_srtt/ep2dbold136s004a001.nii.gz                 \
