...
# execute via : 
#   tcsh -xef afni_srtt_v2_tb0138.tcsh 2>&1 | tee output.afni_srtt_v2_tb0138.tcsh
...
auto_warp.py -base MNI_caez_N27+tlrc -input Sag3DMPRAGEs004a1001_ns+orig \
...
if ( ! -f Sag3DMPRAGEs004a1001_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: Sag3DMPRAGEs004a1001_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    3dNwarpApply -master Sag3DMPRAGEs004a1001_ns+tlrc -dxyz 3                 \
...
3dcopy Sag3DMPRAGEs004a1001_ns+tlrc anat_final.$subj
...
foreach run ( $runs )
    3dmerge -1blur_fwhm 8 -doall -prefix rm.pb04.$subj.r$run.blur    \
...
3dresample -master full_mask.$subj+tlrc -input Sag3DMPRAGEs004a1001_ns+tlrc \
...
3dresample -master full_mask.$subj+tlrc -prefix ./rm.resam.group            \
           -input                                                           \
           /usr/local/apps/afni/current/linux_openmp_64/MNI_caez_N27+tlrc
...
#
# afni_proc.py -subj_id tb0138 -script afni_srtt_v2_tb0138.tcsh -out_dir      \
#     tb0138.srtt_v2 -dsets func_srtt/ep2dbold156s005a001.nii.gz              \
#     func_srtt/ep2dbold156s007a001.nii.gz -blocks despike tshift align tlrc  \
#     volreg blur mask regress -copy_anat anat/Sag3DMPRAGEs004a1001.nii.gz    \
#     -anat_has_skull yes -tcat_remove_first_trs 6 -volreg_align_e2a          \
#     -tlrc_NL_warp -volreg_tlrc_warp -tlrc_base MNI_caez_N27+tlrc            \
#     -align_opts_aea -giant_move -tshift_opts_ts -tpattern alt+z2 -blur_size \
#     8 -volreg_align_to first -volreg_warp_dxyz 3 -regress_stim_times        \
