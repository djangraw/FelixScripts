...
# execute via : 
#   tcsh -xef afni_srtt_tb0138.tcsh 2>&1 | tee output.afni_srtt_tb0138.tcsh
...
3dcopy anat/Sag3DMPRAGEs004a1001.nii.gz $output_dir/Sag3DMPRAGEs004a1001
...
# (new anat will be intermediate, stripped, Sag3DMPRAGEs004a1001_ns+orig)
align_epi_anat.py -anat2epi -anat Sag3DMPRAGEs004a1001+orig \
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGEs004a1001_ns+orig \
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                       \
               Sag3DMPRAGEs004a1001_al_junk_mat.aff12.1D -I                   \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat
    # then apply non-linear standard-space warp
    3dAllineate -base Sag3DMPRAGEs004a1001_ns+orig                            \
...
3dcopy Sag3DMPRAGEs004a1001_ns+orig anat_final.$subj
...
3dNwarpApply -source Sag3DMPRAGEs004a1001+orig                                \
...
foreach run ( $runs )
    3dmerge -1blur_fwhm 8 -doall -prefix rm.pb03.$subj.r$run.blur    \
            pb02.$subj.r$run.volreg+orig

    # and apply extents mask, since no scale block
    3dcalc -a rm.pb03.$subj.r$run.blur+orig -b mask_epi_extents+orig \
           -expr 'a*b' -prefix pb03.$subj.r$run.blur
end
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGEs004a1001_ns+orig \
...
1dcat X.nocensor.xmat.1D'[8]' > ideal_uns1.1D
1dcat X.nocensor.xmat.1D'[9]' > ideal_uns2.1D
1dcat X.nocensor.xmat.1D'[10]' > ideal_uns3.1D
1dcat X.nocensor.xmat.1D'[11]' > ideal_str1.1D
1dcat X.nocensor.xmat.1D'[12]' > ideal_str2.1D
1dcat X.nocensor.xmat.1D'[13]' > ideal_str3.1D
...
#
# afni_proc.py -subj_id tb0138 -script afni_srtt_tb0138.tcsh -out_dir         \
#     tb0138.srtt -dsets func_srtt/ep2dbold156s005a001.nii.gz                 \
#     func_srtt/ep2dbold156s007a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGEs004a1001.nii.gz           \
#     -anat_has_skull yes -tcat_remove_first_trs 6 -volreg_align_e2a          \
#     -tlrc_NL_warp -align_opts_aea -giant_move -tshift_opts_ts -tpattern     \
#     alt+z2 -blur_size 8 -volreg_align_to first -volreg_warp_dxyz 3          \
#     -regress_stim_times stim_times/stim_times_srtt/bl1_c1_unstr.txt         \
#     stim_times/stim_times_srtt/bl2_c1_unstr.txt                             \
#     stim_times/stim_times_srtt/bl3_c1_unstr.txt                             \
#     stim_times/stim_times_srtt/bl1_c2_str.txt                               \
#     stim_times/stim_times_srtt/bl2_c2_str.txt                               \
...
#     -regress_opts_3dD -num_glt 10 -gltsym 'SYM: +uns1 +uns2 +uns3'          \
#     -glt_label 1 unstructured -gltsym 'SYM: +str1 +str2 +str3' -glt_label 2 \
#     structured -gltsym 'SYM: +uns1 +uns2 +uns3 -str1 -str2 -str3'           \
#     -glt_label 3 unstructured-structured -gltsym 'SYM: +str1 -uns1'         \
#     -glt_label 4 'structured-unstructured BL1' -gltsym 'SYM: +str2 -uns2'   \
#     -glt_label 5 'structured-unstructured BL2' -gltsym 'SYM: +str3 -uns3'   \
#     -glt_label 6 'structured-unstructured BL3' -jobs 10 -bash -execute
