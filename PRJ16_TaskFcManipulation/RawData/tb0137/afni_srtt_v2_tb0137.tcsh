...
# execute via : 
#   tcsh -xef afni_srtt_v2_tb0137.tcsh 2>&1 | tee output.afni_srtt_v2_tb0137.tcsh
...
auto_warp.py -base MNI_caez_N27+tlrc -input Sag3DMPRAGEs010a1001_ns+orig \
...
if ( ! -f Sag3DMPRAGEs010a1001_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: Sag3DMPRAGEs010a1001_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    3dNwarpApply -master Sag3DMPRAGEs010a1001_ns+tlrc -dxyz 3                 \
...
3dcopy Sag3DMPRAGEs010a1001_ns+tlrc anat_final.$subj
...
3dresample -master full_mask.$subj+tlrc -input Sag3DMPRAGEs010a1001_ns+tlrc \
...
#
# afni_proc.py -subj_id tb0137 -script afni_srtt_v2_tb0137.tcsh -out_dir      \
#     tb0137.srtt_v2 -dsets func_srtt/ep2dbold156s005a001.nii.gz              \
#     func_srtt/ep2dbold156s007a001.nii.gz                                    \
#     func_srtt/ep2dbold156s009a001.nii.gz -blocks despike tshift align tlrc  \
#     volreg blur mask regress -copy_anat anat/Sag3DMPRAGEs010a1001.nii.gz    \
