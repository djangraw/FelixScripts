...
# execute via : 
#   tcsh -xef afni_srtt_tb0137.tcsh 2>&1 | tee output.afni_srtt_tb0137.tcsh
...
3dcopy anat/Sag3DMPRAGEs010a1001.nii.gz $output_dir/Sag3DMPRAGEs010a1001
...
# (new anat will be intermediate, stripped, Sag3DMPRAGEs010a1001_ns+orig)
align_epi_anat.py -anat2epi -anat Sag3DMPRAGEs010a1001+orig \
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGEs010a1001_ns+orig \
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                       \
               Sag3DMPRAGEs010a1001_al_junk_mat.aff12.1D -I                   \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat
    # then apply non-linear standard-space warp
    3dAllineate -base Sag3DMPRAGEs010a1001_ns+orig                            \
...
3dcopy Sag3DMPRAGEs010a1001_ns+orig anat_final.$subj
...
3dNwarpApply -source Sag3DMPRAGEs010a1001+orig                                \
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGEs010a1001_ns+orig \
...
#
# afni_proc.py -subj_id tb0137 -script afni_srtt_tb0137.tcsh -out_dir         \
#     tb0137.srtt -dsets func_srtt/ep2dbold156s005a001.nii.gz                 \
#     func_srtt/ep2dbold156s007a001.nii.gz                                    \
#     func_srtt/ep2dbold156s009a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGEs010a1001.nii.gz           \
