...
# execute via : 
#   tcsh -xef afni_srtt_tb8136.tcsh 2>&1 | tee output.afni_srtt_tb8136.tcsh
...
3dcopy anat/Sag3DMPRAGEs002a1001A.nii.gz $output_dir/Sag3DMPRAGEs002a1001A
...
# (new anat will be intermediate, stripped, Sag3DMPRAGEs002a1001A_ns+orig)
align_epi_anat.py -anat2epi -anat Sag3DMPRAGEs002a1001A+orig \
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGEs002a1001A_ns+orig \
...
3dbucket -prefix Sag3DMPRAGEs002a1001A_ns                           \
    awpy/Sag3DMPRAGEs002a1001A_ns.aw.nii*
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                       \
               Sag3DMPRAGEs002a1001A_al_junk_mat.aff12.1D -I                  \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat
    # then apply non-linear standard-space warp
    3dAllineate -base Sag3DMPRAGEs002a1001A_ns+orig                           \
...
3dcopy Sag3DMPRAGEs002a1001A_ns+orig anat_final.$subj
...
3dNwarpApply -source Sag3DMPRAGEs002a1001A+orig                               \
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGEs002a1001A_ns+orig \
...
#
# afni_proc.py -subj_id tb8136 -script afni_srtt_tb8136.tcsh -out_dir         \
#     tb8136.srtt -dsets func_srtt/ep2dbold156s005a001.nii.gz                 \
#     func_srtt/ep2dbold156s007a001.nii.gz                                    \
#     func_srtt/ep2dbold156s009a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGEs002a1001A.nii.gz          \
