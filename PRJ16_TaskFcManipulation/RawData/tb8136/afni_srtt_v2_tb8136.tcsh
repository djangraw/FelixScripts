...
# execute via : 
#   tcsh -xef afni_srtt_v2_tb8136.tcsh 2>&1 | tee output.afni_srtt_v2_tb8136.tcsh
...
auto_warp.py -base MNI_caez_N27+tlrc -input Sag3DMPRAGEs002a1001A_ns+orig \
...
if ( ! -f Sag3DMPRAGEs002a1001A_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: Sag3DMPRAGEs002a1001A_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    3dNwarpApply -master Sag3DMPRAGEs002a1001A_ns+tlrc -dxyz 3                \
...
3dcopy Sag3DMPRAGEs002a1001A_ns+tlrc anat_final.$subj
...
3dresample -master full_mask.$subj+tlrc -input Sag3DMPRAGEs002a1001A_ns+tlrc \
...
#
# afni_proc.py -subj_id tb8136 -script afni_srtt_v2_tb8136.tcsh -out_dir      \
#     tb8136.srtt_v2 -dsets func_srtt/ep2dbold156s005a001.nii.gz              \
#     func_srtt/ep2dbold156s007a001.nii.gz                                    \
#     func_srtt/ep2dbold156s009a001.nii.gz -blocks despike tshift align tlrc  \
#     volreg blur mask regress -copy_anat anat/Sag3DMPRAGEs002a1001A.nii.gz   \
