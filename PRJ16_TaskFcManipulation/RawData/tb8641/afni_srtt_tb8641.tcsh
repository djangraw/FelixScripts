...
# execute via : 
#   tcsh -xef afni_srtt_tb8641.tcsh 2>&1 | tee output.afni_srtt_tb8641.tcsh
...
auto_warp.py -base TT_N27+tlrc -input Sag3DMPRAGE_Fixed_ns+orig \
...
foreach run ( $runs )
    ...
    3dAllineate -base Sag3DMPRAGE_Fixed_ns+orig                               \
...
3dcopy Sag3DMPRAGE_Fixed_ns+orig anat_final.$subj
...
3dresample -master full_mask.$subj+orig -input Sag3DMPRAGE_Fixed_ns+orig \
...
#
# afni_proc.py -subj_id tb8641 -script afni_srtt_tb8641.tcsh -out_dir         \
#     tb8641.srtt -dsets func_srtt/ep2dbold156s005a001.nii.gz                 \
#     func_srtt/ep2dbold156s007a001.nii.gz                                    \
#     func_srtt/ep2dbold156s009a001.nii.gz -blocks tshift align tlrc volreg   \
#     blur mask regress -copy_anat anat/Sag3DMPRAGE_Fixed.nii.gz              \
