...
3dDeconvolve -input pb05.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -fout -tout                                                              \
    -x1D_stop                                                                \
    -fitts fitts.censorbase-nofilt.${subj}                                              \
    -errts errts.censorbase-nofilt.${subj}                                              \
    -bucket stats.censorbase-nofilt.${subj}
...
mv stats.REML_cmd stats.censorbase-nofilt.REML_cmd
tcsh -x stats.censorbase-nofilt.REML_cmd
mv 3dREMLfit.err 3dREMLfit.censorbase-nofilt.err # to avoid confusing with old version
