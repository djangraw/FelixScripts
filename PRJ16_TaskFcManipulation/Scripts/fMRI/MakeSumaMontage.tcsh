...
set beta_ind = 30 # index of betas in afni_olay
set thresh_ind = 31 # index of threshold in afni olay

# image props
set image_dir = "./SUMA_IMAGES"        # store jpgs here
set image_pre = "suma_images"        # ... with this prefix
set image_fin = "${image_dir}/Task-Rest_run3_Activ_p01_scale5.jpg"             # final movie name (with suffix)
