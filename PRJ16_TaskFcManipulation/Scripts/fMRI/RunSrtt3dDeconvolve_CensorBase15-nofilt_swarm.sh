...
# RunSrtt3dDeconvolve_CensorBase15-nofilt_swarm.sh
#
...
echo "" > TEMP_Srtt3dD_CensorBase15-nofilt_swarm
for SBJ in ${okSubjects[@]}; do
    echo ${SBJ}
    AfniProc=${PRJDIR}/RawData/${SBJ}/${SBJ}.srtt${folderSuffix}
    echo "cd $AfniProc; bash /data/jangrawdc/PRJ16_TaskFcManipulation/Scripts/fMRI/RunSrtt3dDeconvolve_CensorBase15-nofilt.sh $SBJ" >> TEMP_Srtt3dD_CensorBase15-nofilt_swarm
done
