function RunMultiWindowJlr_v1p3(outDirName,ALLEEG,scope_settings, pop_settings, logist_settings)
% Perform logistic regression with trial jitter on a dataset.
%
%
% RunMultiWindowJlr_v1p3(outDirName,ALLEEG,scope_settings, pop_settings,
%       logist_settings)
%
% INPUTS:
...
if parallel == 1
    parfor foldNum = 1:cv.numFolds % PARFOR!
        ...
        % Perform training
        [vout{foldNum},fwdmodels{foldNum}] = SetUpMultiWindowJlr_v1p3(foldALLEEG{foldNum},trainingwindowlength,trainingwindowoffset,vinit,jitterPriorLoop{foldNum},pop_settings,logist_settings);
