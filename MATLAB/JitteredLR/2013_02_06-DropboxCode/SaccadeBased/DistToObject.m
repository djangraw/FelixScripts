...
% -positions is an nx2 matrix in which the first column is x position and 
% the second column is y position.
% -times is an n-element vector of the eyelink times at which positions 
% should be evaluated.
% 
% OUTPUTS:
