function [pdf,extended_t] = computeJitterPrior_templatematch_pca(t, params)

% This function returns the prior matrix using a gaussian distribution with
% the given parameters.
%
% pdf = computeJitterPrior_templatematch_pca(t, params)
%
% INPUTS:
...
% as described above.
%
% Created 12/5/12 by DJ based on computeJitterPrior_gaussian.m.
