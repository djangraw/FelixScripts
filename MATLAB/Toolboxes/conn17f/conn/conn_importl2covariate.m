...
if dogui
    ...
    while ok
        ...
        if ok,
            ...
            elseif numel(unique(newname))~=numel(newname)||any(ismember(newname,CONN_x.Setup.l2covariates.names(1:end-1))), conn_msgbox('Names must be unique and different than existing second-level covariate names','',2);
            else
