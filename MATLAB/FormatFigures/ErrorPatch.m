function [Pa,Li,t] = ErrorPatch(varargin)
% ERRORPATCH plots jackknife errorbars around a given curve
%
...
% Updated 4/17/12 by DJ - changed name from JackKnife to avoid conflict
% with matlab's stats toolbox function
...
% Li = plot(x,y,LineColor,'linewidth',2);
hold on;
t = toc;
