#!/bin/bash
# 02_MakeRandomParcellations_NonRandomAtlas.sh
#
# Created 4/22/16 by DJ to mimic 02_MakeRandomParcellations.sh but with real Craddock atlas.
...
mv $maskname ${outPrefix}_200ROIs_-1.nii
gzip ${outPrefix}_200ROIs_-1.nii
