function [P,Rsq,pred_pos,pred_neg,pred_glm] = TestRosenbergPredictions_CogStates_Natasha(FC,attnNets,behavior_avg_PC,taskNames,doRandBeh,doRand,fcTasks,behTasks,doPlot)
