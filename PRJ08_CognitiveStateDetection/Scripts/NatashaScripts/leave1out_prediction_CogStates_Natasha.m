function [P,Rsq,pred_pos,pred_neg,pred_glm,pos_mask_all,neg_mask_all] = ...
    leave1out_prediction_CogStates_Natasha(FC,behavior_avg_PC,taskNames,doRandBeh,doRand,fcTasks,behTasks,doPlot)

% leave1out_prediction_CogStates_Natasha.m
%
