...
do
    ...
    subjMask=pb06.${subject}_CTask001.bpf.WL${winLength}.mask.lowSigma+orig
    ...
    prefix=${subjAtlasPrefix}_WL${winLength}_ # TS.1D will be appended to end
...
#!/bin/bash
python TsExtractByROIs.py -Mask ${dataDir}${subjMask}.HEAD -Atlas ${dataDir}${subjAtlasPrefix}_10VoxelMin+orig.HEAD -EPI ${dataDir}${epiFile}.HEAD -prefix ${dataDir}$prefix
EOF
    # print it
