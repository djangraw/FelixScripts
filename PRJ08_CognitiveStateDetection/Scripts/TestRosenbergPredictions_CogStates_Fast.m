function [P,Rsq,pred_pos,pred_neg,pred_glm,behav] = TestRosenbergPredictions_CogStates_Fast(FC,attnNets,behavior_avg_PC,taskNames,doRandBeh,doRand,fcTasks,behTasks,doPlot)
% TestRosenbergPredictions_CogStates_Fast.m
%
