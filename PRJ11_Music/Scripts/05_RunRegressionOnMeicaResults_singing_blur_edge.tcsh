#!/bin/tcsh -xef
# 05_RunRegressionOnMeicaResults_singing_blur_edge
#
# USAGE:
#   tcsh -xef 05_RunRegressionOnMeicaResults_singing_blur_edge.tcsh $subj $nRuns $echoTimes $outFolder 2>&1 | tee output.05_RunRegressionOnMeicaResults_blur_edge.$subj.$outFolder
#
# INPUTS:
...
# Updated 5/1/17 by DJ - modified to _blur version
...
# foreach run ( $runs )
#     3dmerge -1blur_fwhm 8.0 -doall -prefix bl06.$subj.r$run.blur \
#             -overwrite pb05.$subj.r$run.meica.nii
# end
#
#
# # ================================ scale =================================
...
#     3dTstat -overwrite -prefix bl.mean.r${run} bl06.${subj}.r${run}.blur+tlrc
#     # Scale
#     3dcalc -a bl06.${subj}.r${run}.blur+tlrc -b bl.mean.r${run}+tlrc \
#         -m mask_anat.${subj}+tlrc \
#         -expr 'min(200, a/b*100) *step(a)*step(b)*step(m)' \
#             -overwrite -prefix bl07.${subj}.r${run}.scale
# end


# ================================ regress =================================
# motion/censor stuff ALREADY DONE
...
3dDeconvolve -input bl07.${subj}.r*.scale+tlrc.HEAD                           \
    ...
    -stim_file 25 WM_Timecourse.1D -stim_base 25 -stim_label 25 WM_tc    \
    -stim_file 26 CSF_Timecourse.1D -stim_base 26 -stim_label 26 CSF_tc    \
    -stim_file 27 bl.MaskData_1_62_74.1D -stim_base 27 -stim_label 27 par_edge_tc    \
    -stim_file 28 bl.MaskData_-1_104_8.1D -stim_base 28 -stim_label 28 occ_edge_tc    \
    -stim_times_AM1 29 ../stimuli/${subj}_Listen.1D 'dmBLOCK4(1)' -stim_label 29 listen \
    -fout -tout -x1D bl_edge.X.xmat.1D -xjpeg bl_edge.X.jpg                                   \
    -x1D_uncensored bl_edge.X.nocensor.xmat.1D                                        \
    -x1D_stop                                                                 \
    -errts bl_edge.errts.$subj                                                        \
    -bucket bl_edge.stats.$subj                                                       \
    -cbucket bl_edge.cbucket.$subj                                                    \
    -jobs 32 \
    -overwrite

# Declare number of nuisance regressors, excluding stimulus regressors
set iLastNuisanceReg = 35 # total regressors + 5*nRuns (polorts) - 5 (stim regressors) - 1 (zero-based)
...
3dDeconvolve -input bl07.${subj}.r*.scale+tlrc.HEAD                           \
    ...
    -stim_file 13 WM_Timecourse.1D -stim_base 13 -stim_label 13 WM_tc    \
    -stim_file 14 CSF_Timecourse.1D -stim_base 14 -stim_label 14 CSF_tc    \
    -stim_file 15 bl.MaskData_1_62_74.1D -stim_base 15 -stim_label 15 par_edge_tc    \
    -stim_file 16 bl.MaskData_-1_104_8.1D -stim_base 16 -stim_label 16 occ_edge_tc    \
    -stim_times_AM1 16 ../stimuli/${subj}_Improvise.1D 'dmBLOCK4(1)' -stim_label 16 improvise \
    -fout -tout -x1D bl_edge.X.xmat.1D -xjpeg bl_edge.X.jpg                                   \
    -x1D_uncensored bl_edge.X.nocensor.xmat.1D                                        \
    -x1D_stop                                                                 \
    -errts bl_edge.errts.$subj                                                        \
...
# Declare number of nuisance regressors, excluding stimulus regressors
set iLastNuisanceReg = 20 # total regressors + 5*nRuns (polorts) - 5 (stim regressors) - 1 (zero-based)
...
3dDeconvolve -input bl07.${subj}.r*.scale+tlrc.HEAD                           \
    ...
    -stim_file 15 bl.MaskData_1_62_74.1D -stim_base 15 -stim_label 15 par_edge_tc    \
    -stim_file 16 bl.MaskData_-1_104_8.1D -stim_base 16 -stim_label 16 occ_edge_tc    \
    -stim_file 17 bl.MaskData_-2_92_40.1D -stim_base 17 -stim_label 17 supocc_edge_tc    \
    -stim_file 18 bl.MaskData_-1_-67_-20.1D -stim_base 18 -stim_label 18 frontpole_edge_tc    \
    -fout -tout -x1D bl_edge.X.xmat.1D -xjpeg bl_edge.X.jpg                                   \
    -x1D_uncensored bl_edge.X.nocensor.xmat.1D                                        \
    -x1D_stop                                                                 \
    -errts bl_edge.errts.$subj                                                        \
...
# Declare number of nuisance regressors, excluding stimulus regressors
set iLastNuisanceReg = 22 # total regressors + 5*nRuns (polorts) - 5 (stim regressors) - 1 (zero-based)
...
3dDeconvolve -input bl07.${subj}.r*.scale+tlrc.HEAD                               \
    ...
    -stim_file 99 bl.MaskData_1_62_74.1D -stim_base 99 -stim_label 99 par_edge_tc    \
    -stim_file 100 bl.MaskData_-1_104_8.1D -stim_base 100 -stim_label 100 occ_edge_tc    \
    -stim_file 101 bl.MaskData_-2_92_40.1D -stim_base 101 -stim_label 101 supocc_edge_tc    \
    -stim_file 102 bl.MaskData_-1_-67_-20.1D -stim_base 102 -stim_label 102 frontpole_edge_tc    \
    -stim_times_AM1 103 ../stimuli/${subj}_Sing.1D 'dmBLOCK4(1)' -stim_label 103 sing \
    -stim_times_AM1 104 ../stimuli/${subj}_Speak.1D 'dmBLOCK4(1)' -stim_label 104 speak \
    -stim_times_AM1 105 ../stimuli/${subj}_Imagine.1D 'dmBLOCK4(1)' -stim_label 105 imagine \
    -stim_times_AM1 106 ../stimuli/${subj}_Rest.1D 'dmBLOCK4(1)' -stim_label 106 rest \
    ...
    -gltsym ../glt_files/glt_speak-sing.txt -glt_label 7 SpeakVsSing                      \
    -gltsym ../glt_files/glt_imagine-sing.txt -glt_label 8 ImagineVsSing                      \
    -gltsym ../glt_files/glt_imagine-speak.txt -glt_label 9 ImagineVsSpeak                      \
    -fout -tout -x1D bl_edge.X.xmat.1D -xjpeg bl_edge.X.jpg                                   \
    -x1D_uncensored bl_edge.X.nocensor.xmat.1D                                        \
    -x1D_stop                                                                 \
    -errts bl_edge.errts.$subj                                                        \
...
# Declare number of nuisance regressors, excluding stimulus regressors
set iLastNuisanceReg = 142 # total regressors + 5*nRuns (polorts) - 5 (stim regressors) - 1 (zero-based)

endif

# -- use 3dTproject to project out regression matrix WITHOUT STIM REGRESSORS --
3dTproject -polort 0 -input bl07.$subj.r*.scale+tlrc.HEAD                    \
           -censor censor_${subj}_combined_2.1D -cenmode ZERO                 \
           -ort bl_edge.X.nocensor.xmat.1D[0..${iLastNuisanceReg}] -overwrite -prefix bl_edge.errts.${subj}.tproject
...
1d_tool.py -show_cormat_warnings -infile bl_edge.X.xmat.1D |& tee bl_edge.out.cormat_warn.txt

# -- execute the 3dREMLfit script, written by 3dDeconvolve --
# Rename and Run 3dREMLfit
mv bl_edge.REML_cmd bl_edge.stats.$subj.REML_cmd
tcsh -x bl_edge.stats.$subj.REML_cmd
