...
#
# USAGE:
#   tcsh -xef 05_RunRegressionOnMeicaResults $subj $nRuns $echoTimes $outFolder 2>&1 | tee output.05_RunRegressionOnMeicaResults.$subj.$outFolder
# 
# INPUTS:
...
foreach run ( $runs )
    3dAutomask -dilate 1 -prefix rm.mask_r${run} pb05.${subj}.r${run}.meica.nii
end
