#/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_023.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE
...
if [ ! -e /data/steelad/Baker/SubjectData/HV_023/rest_2/HV_023.anat.ss_do.nii.gz ]; then 3dWarp -overwrite -prefix /data/steelad/Baker/SubjectData/HV_023/rest_2/HV_023.anat.ss_do.nii.gz -deoblique /data/steelad/Baker/SubjectData/HV_023/rest_2/HV_023.anat.ss+orig; fi
echo "
++++++++++++++++++++++++" 
echo +* "Copy in functional datasets, reset NIFTI tags as needed" 
3dcalc -a /data/steelad/Baker/SubjectData/HV_023/rest_2/echo_001_dataset+orig -expr 'a' -prefix ./echo_001_dataset.nii
3dcalc -a /data/steelad/Baker/SubjectData/HV_023/rest_2/echo_002_dataset+orig -expr 'a' -prefix ./echo_002_dataset.nii
3dcalc -a /data/steelad/Baker/SubjectData/HV_023/rest_2/echo_003_dataset+orig -expr 'a' -prefix ./echo_003_dataset.nii
echo "
++++++++++++++++++++++++" 
...
3dWarp -verb -card2oblique ./echo_001_dataset.nii[0] -overwrite  -newgrid 1.000000 -prefix ./HV_023.anat.ss_ob.nii.gz /data/steelad/Baker/SubjectData/HV_023/rest_2/HV_023.anat.ss_do.nii.gz | \grep  -A 4 '# mat44 Obliquity Transformation ::'  > echo_001_dataset_obla2e_mat.1D
...
cp /data/steelad/Baker/SubjectData/HV_023/rest_2/HV_023.anat.ss_do.nii.gz* .
...
3dNotes -h '/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_023.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE (T2* weighted average of ME time series, produced by ME-ICA v2.5)' TED/rest_2_tsoc.nii
gzip -f TED/rest_2_medn.nii TED/rest_2_mefc.nii TED/rest_2_tsoc.nii TED/rest_2_mefl.nii
mv TED/rest_2_medn.nii.gz TED/rest_2_mefc.nii.gz TED/rest_2_tsoc.nii.gz TED/rest_2_mefl.nii.gz /data/steelad/Baker/SubjectData/HV_023/rest_2
