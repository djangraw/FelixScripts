#/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_003.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE
...
if [ ! -e /data/steelad/Baker/SubjectData/HV_003/rest_2/HV_003.anat.ss_do.nii.gz ]; then 3dWarp -overwrite -prefix /data/steelad/Baker/SubjectData/HV_003/rest_2/HV_003.anat.ss_do.nii.gz -deoblique /data/steelad/Baker/SubjectData/HV_003/rest_2/HV_003.anat.ss+orig; fi
echo "
++++++++++++++++++++++++" 
echo +* "Copy in functional datasets, reset NIFTI tags as needed" 
3dcalc -a /data/steelad/Baker/SubjectData/HV_003/rest_2/echo_001_dataset+orig -expr 'a' -prefix ./echo_001_dataset.nii
3dcalc -a /data/steelad/Baker/SubjectData/HV_003/rest_2/echo_002_dataset+orig -expr 'a' -prefix ./echo_002_dataset.nii
3dcalc -a /data/steelad/Baker/SubjectData/HV_003/rest_2/echo_003_dataset+orig -expr 'a' -prefix ./echo_003_dataset.nii
echo "
++++++++++++++++++++++++" 
...
3dWarp -verb -card2oblique ./echo_001_dataset.nii[0] -overwrite  -newgrid 1.000000 -prefix ./HV_003.anat.ss_ob.nii.gz /data/steelad/Baker/SubjectData/HV_003/rest_2/HV_003.anat.ss_do.nii.gz | \grep  -A 4 '# mat44 Obliquity Transformation ::'  > echo_001_dataset_obla2e_mat.1D
...
cp /data/steelad/Baker/SubjectData/HV_003/rest_2/HV_003.anat.ss_do.nii.gz* .
echo --------"Using alignp_mepi_anat.py to drive T2*-map weighted anatomical-functional coregistration" 
3daxialize -overwrite -prefix ./HV_003.anat.ss_ob.nii.gz ./HV_003.anat.ss_ob.nii.gz
/usr/local/Python/2.7.7/bin/python /data/steelad/Baker/BIOWULF/me-ica/meica.libs/alignp_mepi_anat.py -t t2svm_ss.nii.gz -a HV_003.anat.ss_ob.nii.gz -p mepi 
cp alignp.mepi/mepi_al_mat.aff12.1D ./HV_003.anat.ss_al_mat.aff12.1D
cat_matvec -ONELINE   echo_001_dataset_obla2e_mat.1D HV_003.anat.ss_al_mat.aff12.1D -I > echo_001_dataset_wmat.aff12.1D
cat_matvec -ONELINE   echo_001_dataset_obla2e_mat.1D HV_003.anat.ss_al_mat.aff12.1D -I  echo_001_dataset_vrmat.aff12.1D  > echo_001_dataset_vrwmat.aff12.1D
echo "
++++++++++++++++++++++++" 
echo +* "Extended preprocessing of functional datasets" 

echo --------"Preparing functional masking for this ME-EPI run" 
3dZeropad  -I 15 -S 15 -A 15 -P 15 -L 15 -R 15  -prefix eBvrmask.nii.gz ocv_ss.nii.gz[0]
voxsize=`ccalc $(3dinfo -voxvol eBvrmask.nii.gz)**.33`
3dAllineate -overwrite -final NN -NN -float -1Dmatrix_apply echo_001_dataset_wmat.aff12.1D -base eBvrmask.nii.gz -input eBvrmask.nii.gz -prefix ./eBvrmask.nii.gz -master HV_003.anat.ss_do.nii.gz -mast_dxyz 3
3dAllineate -overwrite -final NN -NN -float -1Dmatrix_apply echo_001_dataset_wmat.aff12.1D -base eBvrmask.nii.gz -input t2svm_ss.nii.gz -prefix ./t2svm_ss_vr.nii.gz -master HV_003.anat.ss_do.nii.gz -mast_dxyz 3
3dAllineate -overwrite -final NN -NN -float -1Dmatrix_apply echo_001_dataset_wmat.aff12.1D -base eBvrmask.nii.gz -input ocv_uni+orig -prefix ./ocv_uni_vr.nii.gz -master HV_003.anat.ss_do.nii.gz -mast_dxyz 3
3dAllineate -overwrite -final NN -NN -float -1Dmatrix_apply echo_001_dataset_wmat.aff12.1D -base eBvrmask.nii.gz -input s0v_ss.nii.gz -prefix ./s0v_ss_vr.nii.gz -master HV_003.anat.ss_do.nii.gz -mast_dxyz 3
...
cp TED/ts_OC.nii TED/rest_2_tsoc.nii
cp TED/dn_ts_OC.nii TED/rest_2_medn.nii
cp TED/betas_hik_OC.nii TED/rest_2_mefc.nii
cp TED/betas_OC.nii TED/rest_2_mefl.nii
cp TED/comp_table.txt /data/steelad/Baker/SubjectData/HV_003/rest_2/rest_2_ctab.txt
3dNotes -h '/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_003.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE (Denoised timeseries (including thermal noise), produced by ME-ICA v2.5)' TED/rest_2_medn.nii
3dNotes -h '/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_003.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE (Denoised ICA coeff. set for ME-ICR seed-based FC analysis, produced by ME-ICA v2.5)' TED/rest_2_mefc.nii
3dNotes -h '/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_003.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE (Full ICA coeff. set for component assessment, produced by ME-ICA v2.5)' TED/rest_2_mefc.nii
3dNotes -h '/data/steelad/Baker/BIOWULF/me-ica//meica.py -d echo_001_dataset+orig,echo_002_dataset+orig,echo_003_dataset+orig -e 14.9,28.4,41.9 -a HV_003.anat.ss+orig --no_skullstrip -b 60s --fres=3 --prefix rest_2 --cpus=8 --OVERWRITE (T2* weighted average of ME time series, produced by ME-ICA v2.5)' TED/rest_2_tsoc.nii
gzip -f TED/rest_2_medn.nii TED/rest_2_mefc.nii TED/rest_2_tsoc.nii TED/rest_2_mefl.nii
mv TED/rest_2_medn.nii.gz TED/rest_2_mefc.nii.gz TED/rest_2_tsoc.nii.gz TED/rest_2_mefl.nii.gz /data/steelad/Baker/SubjectData/HV_003/rest_2
