...
# 3dLME_2Grps_readScoreMedSplit_n69_diffs.R
#
...
# Updated 4/30/19 by DJ - diffs version for 2-condition comparison (removed r2z and z2r calls)

# get inputs
args <- commandArgs(trailingOnly=TRUE)

# list labels for Group 1 - ReadScore <= MEDIAN(ReadScore)
G1Subj <- c('h1029','h1097','h1108','h1046','h1038','h1034','h1187','h1024','h1003','h1083','h1120','h1180','h1161','h1174','h1129','h1088','h1035','h1096','h1176','h1150','h1197','h1163','h1058','h1142','h1106','h1184','h1095','h1153','h1168','h1059','h1004','h1057','h1087','h1054','h1154')
...
if (length(args)>1) {
  ...
  # Output file name
  outFile <- '3dLME_2Grps_readScoreMedSplit_n69_Automask'
...
if (nNodes>1) {
   ...
   clusterExport(cl, c('genLab'), envir=environment())
