...
SetUpSumaMontage_4view('/data/NIMH_Haskins/a182_v2/GROUP_block_tlrc','TEMP_AUD-VIS.tcsh','MNI152_2009_SurfVol.nii',...
    ...
    20,21,'./SUMA_IMAGES','','SUMA_IMAGES/suma_4view_1grp_aud-vis_lim0p2_q01.jpg',[],0.2,'0.01 *q','');

%% 1-grp Aud+Vis, q<0.01
SetUpSumaMontage_4view('/data/NIMH_Haskins/a182_v2/GROUP_block_tlrc','TEMP_AUD+VIS.tcsh','MNI152_2009_SurfVol.nii',...
    'ttest_allSubj_1grp_minus12+tlrc','suma_MNI152_2009/MNI152_2009_both.spec','MNI152_2009_SurfVol.nii',...
    14,15,'./SUMA_IMAGES','','SUMA_IMAGES/suma_4view_1grp_aud+vis_lim0p2_q01.jpg',[],0.2,'0.01 *q','');

%% 1-grp Aud, q<0.01
SetUpSumaMontage_4view('/data/NIMH_Haskins/a182_v2/GROUP_block_tlrc','TEMP_AUD.tcsh','MNI152_2009_SurfVol.nii',...
    'ttest_allSubj_1grp_minus12+tlrc','suma_MNI152_2009/MNI152_2009_both.spec','MNI152_2009_SurfVol.nii',...
    2,3,'./SUMA_IMAGES','','SUMA_IMAGES/suma_4view_1grp_aud_lim0p2_q01.jpg',[],0.2,'0.01 *q','');

%% 1-grp Vis, q<0.01
SetUpSumaMontage_4view('/data/NIMH_Haskins/a182_v2/GROUP_block_tlrc','TEMP_VIS.tcsh','MNI152_2009_SurfVol.nii',...
    'ttest_allSubj_1grp_minus12+tlrc','suma_MNI152_2009/MNI152_2009_both.spec','MNI152_2009_SurfVol.nii',...
    8,9,'./SUMA_IMAGES','','SUMA_IMAGES/suma_4view_1grp_vis_lim0p2_q01.jpg',[],0.2,'0.01 *q','');
...
SetUpSumaMontage_4view('/data/NIMH_Haskins/a182_v2/IscResults/Group','TEMP_AUD-VIS_CLUST.tcsh','MNI152_2009_SurfVol.nii',...
    ...
    6,7,'./SUMA_IMAGES','','SUMA_IMAGES/suma_4view_ISC_top-bot_lim0p1_q01.jpg',[],0.1,'0.01 *q','');
