...
3dDeconvolve -input pb05.$subj.r*.scale+tlrc.HEAD                           \
    ...
    -jobs 12                                                             \
    -fout -tout -x1D X.block_minus12.xmat.1D -xjpeg X.block_minus12.jpg                  \
    -x1D_uncensored X.block_minus12.nocensor.xmat.1D -x1D_stop                   \
    -fitts fitts.block_minus12.$subj                                             \
    -errts errts.block_minus12.${subj}                                           \
    -bucket stats.block_minus12.$subj
...
1d_tool.py -show_cormat_warnings -infile X.block_minus12.xmat.1D |& tee out.block_minus12.cormat_warn.txt

# -- execute the 3dREMLfit script, written by 3dDeconvolve --
mv stats.REML_cmd stats.block_minus12.REML_cmd
tcsh -x stats.block_minus12.REML_cmd
