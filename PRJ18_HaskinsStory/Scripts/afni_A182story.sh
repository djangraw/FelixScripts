...
story()
{
	...
	afni_proc.py -subj_id ${1} -script afni_storyrest_${1}.tcsh -out_dir ${1}.storyrest \
	...
	-regress_stim_times stim_times/stim_times_story/c0*.txt stim_times/stim_times_story/c1*.txt stim_times/stim_times_story/c2*.txt \
