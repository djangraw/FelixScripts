# list lables for Group 1 - GPTSA < MEDIAN(GPTSA)
G1Subj <- c('tb3132','tb3240','tb3512','tb3592','tb3646','tb3810','tb3858','tb3929','tb3977','tb4450','tb4572')

# list lables for Group 2 - GPTSA > MEDIAN(GPTSA)
G2Subj <- c('tb2994','tb3279','tb3602','tb3626','tb3744','tb3757','tb3784','tb3846','tb3920','tb3964','tb4547')

# File that contains all the input files as one column
inFile <- './data_n22_Inscapes.txt'

# Output file name

outFile <- './3dLME_2Grps_gptsaMedSplit_n22_Inscapes_noAutomask'
