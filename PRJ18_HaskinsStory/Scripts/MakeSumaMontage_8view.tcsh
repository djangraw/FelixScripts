...
########################################################################
#
# MakeSumaMontage_8view.tcsh: open up AFNI, overlay a value dset, threshold
...
# Updated 4/29/19 by DJ - adapted to be 8-view instead of 4
...
# set beta_ind = 114 # index of betas in afni_olay
# set thresh_ind = 115 # index of threshold in afni olay
#
# # image props
...
# set my_cbar = "Reds_and_Blues_w_Green FLIP" # add FLIP to flip sign of normal colorbar
# # set my_cbar = "ROI_i32" # For Conjunction Analysis
