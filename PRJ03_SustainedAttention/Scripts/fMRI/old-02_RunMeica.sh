...
# ===============================================================   
# Usage:
#   RunMeica SubjectID FilePrefix
#
# Inputs:
#   * SubjectID, e.g., SBJ01
#   * FilePrefix, e.g., SBJ01_AUDIO_Gating_Run01
#
# Outputs:
#   * Construct directory and copy relevant files into it
#   * Construct MEICA script
#   * Run MEICA script, producing python/html outputs
#
# Created 07/15/2014 by Javier Gonzalez-Castillo, ???
# Updated 11/2/15 by DJ - switched _E01 to _e1, etc.
# ===============================================================   
...
# NAME FILES FOR EACH ECHO
EFile01=`echo ${FILEPREFIX}_e1`
EFile02=`echo ${FILEPREFIX}_e2`
EFile03=`echo ${FILEPREFIX}_e3`
