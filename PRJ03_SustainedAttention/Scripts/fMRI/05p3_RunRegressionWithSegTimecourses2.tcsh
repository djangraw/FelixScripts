#!/bin/tcsh -xef
# 05p3_RunRegressionWithSegTimecourses2.tcsh
#
...
#
# OUTPUTS:
#	- 3dDeconvolve output files with suffix _withSegTc2.
#
# Created 5/19/16 by DJ based on 05_RunRegressionOnMeicaResults.tcsh.
# Updated 11/14/16 by DJ - added band-pass filter back in
# Updated 12/21/16 by DJ - copied from 05p3_RunRegressionWithSegTimecourses.tcsh - now this version has GM subtraction, that one doesn't.
...
3dDeconvolve -input pb06.${subj}.r*.scale+tlrc.HEAD                           \
    ...
    -fout -tout -x1D X_withSegTc2.xmat.1D -xjpeg X_withSegTc2.jpg                                   \
    -x1D_uncensored X_withSegTc2.nocensor.xmat.1D                                        \
    -x1D_stop                                                                 \
    -errts errts_withSegTc2.$subj                                                        \
    -bucket stats_withSegTc2.$subj                                                       \
    -cbucket cbucket_withSegTc2.$subj                                                    \
    -jobs 32 \
    -overwrite
...
3dTproject -polort 0 -input pb06.$subj.r*.scale+tlrc.HEAD                    \
           ...
           -ort X_withSegTc2.nocensor.xmat.1D \
           -overwrite -prefix errts_withSegTc2.${subj}.tproject
...
1d_tool.py -show_cormat_warnings -infile X_withSegTc2.xmat.1D |& tee out.cormat_warn_withSegTc2.txt
