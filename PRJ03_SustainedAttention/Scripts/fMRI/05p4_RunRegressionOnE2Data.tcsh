#!/bin/tcsh -xef
# 05p4_RunRegressionOnE2Data.tcsh
#
# USAGE:
#   tcsh -xef 05p4_RunRegressionOnE2Data.tcsh $subj $outFolder 2>&1 | tee output.05p4_RunRegressionOnE2Data.$subj
# 
# INPUTS:
...
#
# OUTPUTS:
#	- 3dDeconvolve output files with suffix _e2.
#
# Created 6/13/16 by DJ based on 05_RunRegressionOnMeicaResults.tcsh.
...
set nRuns = `ls pb04.$subj.r*_e2.in.nii.gz | wc -l`
echo "Found ${nRuns} runs for subject ${subj}."	

# run the regression analysis
# ECHO2: use output from pb04 as input
# TODO: make this flexible to varying nRuns
if ( $nRuns == 3 ) then
3dDeconvolve -input pb04.$subj.r*_e2.in.nii.gz                                \
    ...
    -fout -tout -x1D X_e2.xmat.1D -xjpeg X_e2.jpg                             \
    -x1D_uncensored X_e2.nocensor.xmat.1D                                     \
    -fitts fitts_e2.$subj+tlrc                                                \
    -errts errts_e2.${subj}+tlrc                                           \
    -x1D_stop                                                                 \
    -bucket stats_e2.$subj                                                    \
    -overwrite
...
3dTproject -polort 0 -input pb04.$subj.r*_e2.in.nii.gz                        \
           ...
           -ort X_e2.nocensor.xmat.1D -prefix errts_e2.${subj}.tproject
...
1d_tool.py -show_cormat_warnings -infile X_e2.xmat.1D |& tee out.cormat_warn.txt
