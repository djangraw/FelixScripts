...
function multiObjectTracking_DJ(video)
...
for iFrame=1:size(video,3)
    frame = repmat(video(:,:,iFrame),1,1,3);
...
%         obj.maskPlayer = vision.VideoPlayer('Position', [740, 400, 700, 400]);
        obj.videoPlayer = vision.VideoPlayer('Position', [20, 400, 240, 320]);
        obj.maskPlayer = vision.VideoPlayer('Position', [740, 400, 240, 320]);
